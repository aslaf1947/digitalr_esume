...
const Preview = () => {
  ...
  return (
    <Suspense fallback={<div>Loading drag-and-drop stuff...</div>}>
      ...
      />
        ...
        <DragDropContext onDragEnd={onDragEnd}>
          <div className="f-col items-center mb-1">
            ...
            <h1 className="name" contentEditable suppressContentEditableWarning>{resumeData.name}</h1>
            <p className="profession" contentEditable suppressContentEditableWarning> {resumeData.position}</p>
            <ContactInfo
            ...
            <div className="col-span-1 space-y-2">
              {resumeData.summary.length > 0 && (
                <div className="mb-1">
                  ...
                  <p className="content break-words"  contentEditable suppressContentEditableWarning>{resumeData.summary}</p>
                </div>
              )}
              <div>
                  ...
                  <div className="mb-1">
                    ...
                    {resumeData.education.map((item, index) => (
                      <div key={index} className="mb-1">
                        <p className="content i-bold"                         contentEditable
                        suppressContentEditableWarning> {item.degree}</p>
                        <p className="content"                         contentEditable
                        suppressContentEditableWarning>{item.school}</p>
                        <DateRange
